    ...
    <div className="blog-post-container">
      ...
      {/* <div className="related-posts">
        ...
        <div className="related-grid">
          <RelatedPostCard 
            title="The History of LGBTQIA+ Rights in Africa" 
            tags={["history", "activism"]}
          />
          <RelatedPostCard 
            title="Understanding Non-Binary Identities" 
